...
initConn (getConn -> conn) = do
  execute_ conn "CREATE TABLE IF NOT EXISTS refs (src TEXT, occ TEXT, mod TEXT, unit TEXT, file TEXT, sl INTEGER, sc INTEGER, el INTEGER, ec INTEGER)"
  ...
  execute_ conn "CREATE TABLE IF NOT EXISTS decls (hieFile TEXT, occ TEXT, file TEXT, sl INTEGER, sc INTEGER, el INTEGER, ec INTEGER, is_root BOOL)"
  execute_ conn "CREATE TABLE IF NOT EXISTS defs (hieFile TEXT, occ TEXT, file TEXT, sl INTEGER, sc INTEGER, el INTEGER, ec INTEGER)"
